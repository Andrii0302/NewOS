...
struct tss tss;
struct gdt gdt_real[NEWOS_TOTAL_GDT_SEGMENTS];
struct gdt_structured gdt_structured[NEWOS_TOTAL_GDT_SEGMENTS] = {
...
void kernel_main()
{
    ...
    gdt_structured_to_gdt(gdt_real, gdt_structured, NEWOS_TOTAL_GDT_SEGMENTS);
